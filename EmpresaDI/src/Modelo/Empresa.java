...
public class Empresa {
    ...
    public Empresa(long id, String nombre, List<Cliente> ListadoClientes) {
        this.id = id;
        this.nombre = nombre;
        this.listadoClientes = new ArrayList();
        this.listadoEmpleados = new ArrayList();
        this.listadoDirectivo = new ArrayList();
    }
     public Empresa(long id, String nombre, List<Cliente> ListadoClientes, List<Empleado> ListaEmpleados) {
        this.id = id;
        this.nombre = nombre;
